...
function shuffleCards() {
  ...
  console.log("icon numbers :", iconNumber);
...
function sneekCards() {
  ...
  if (sneaks >= 0) {
    ...
    showCardsBtn.classList.add("hide");
    sneekCardsBtn.classList.add("hide");
    setTimeout(() => {
      addCardCover();
      sneekCardsBtn.classList.remove("hide");
      showCardsBtn.classList.remove("hide");
    }, 2000);
  } else {
